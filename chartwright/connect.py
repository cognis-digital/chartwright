"""Native cognis-connect emit for chartwright — forward findings to any platform.

Maps chartwright's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    chartwright ... --format json | chartwright-emit --to stix
    chartwright-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
